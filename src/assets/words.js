...
const WORDS = [
  ...
  { en: "accompany", th: "ไปกับ, ร่วมทาง", cat: "verbs" },
  { en: "analyse", th: "วิเคราะห์", cat: "verbs" },
  { en: "allocate", th: "จัดสรร", cat: "verbs" },
  { en: "alleviate", th: "บรรเทา, ทำให้เบาบาง", cat: "verbs" },
  { en: "bolster", th: "เสริมให้แข็งแรง, สนับสนุน", cat: "verbs" },
  { en: "commence", th: "เริ่มต้น", cat: "verbs" },
  { en: "conserve", th: "อนุรักษ์", cat: "verbs" },
  { en: "constrain", th: "จำกัด, บีบบังคับ", cat: "verbs" },
  { en: "demonstrate", th: "สาธิต, แสดงให้เห็น", cat: "verbs" },
  { en: "deteriorate", th: "เสื่อมลง", cat: "verbs" },
  { en: "enrich", th: "ทำให้เข้มข้นขึ้น, ทำให้ร่ำรวยขึ้น", cat: "verbs" },
  { en: "exacerbate", th: "ทำให้รุนแรงขึ้น", cat: "verbs" },
  { en: "implement", th: "นำไปใช้, ดำเนินการ", cat: "verbs" },
  { en: "integrate", th: "ผสานรวม", cat: "verbs" },
  { en: "maximise", th: "ทำให้มากที่สุด", cat: "verbs" },
  { en: "mitigate", th: "บรรเทา, ลดความรุนแรง", cat: "verbs" },
  { en: "overcome", th: "เอาชนะ, ผ่านพ้น", cat: "verbs" },
  { en: "pursue", th: "ติดตาม, ไล่ตาม", cat: "verbs" },
  { en: "revise", th: "ทบทวน, แก้ไขปรับปรุง", cat: "verbs" },
  { en: "safeguard", th: "ปกป้อง", cat: "verbs" },
  { en: "scrutinise", th: "ตรวจสอบอย่างละเอียด", cat: "verbs" },
  { en: "subsidise", th: "อุดหนุน", cat: "verbs" },
  { en: "thrive", th: "เจริญรุ่งเรือง", cat: "verbs" },
  { en: "undermine", th: "บ่อนทำลาย", cat: "verbs" },
  { en: "uphold", th: "รักษาไว้, สนับสนุน", cat: "verbs" },
  { en: "verify", th: "ตรวจสอบความถูกต้อง", cat: "verbs" },
  { en: "withstand", th: "ต้านทาน, ทนต่อ", cat: "verbs" },
  ...
  { en: "balanced", th: "สมดุล", cat: "adjective" },
  { en: "constructive", th: "สร้างสรรค์, เป็นประโยชน์", cat: "adjective" },
  { en: "crucial", th: "สำคัญมาก", cat: "adjective" },
  { en: "cumulative", th: "ที่เพิ่มขึ้นเรื่อยๆ", cat: "adjective" },
  { en: "holistic", th: "โดยรวม, ทั้งหมด", cat: "adjective" },
  { en: "integral", th: "สำคัญยิ่ง", cat: "adjective" },
  { en: "lucrative", th: "ทำกำไรดี", cat: "adjective" },
  { en: "momentous", th: "มีความสำคัญยิ่ง", cat: "adjective" },
  { en: "overwhelming", th: "ท่วมท้น, ล้นหลาม", cat: "adjective" },
  { en: "prevalent", th: "แพร่หลาย", cat: "adjective" },
  { en: "profound", th: "ลึกซึ้ง", cat: "adjective" },
  { en: "progressive", th: "ก้าวหน้า", cat: "adjective" },
  { en: "prominent", th: "เด่นชัด", cat: "adjective" },
  { en: "rigorous", th: "เข้มงวด", cat: "adjective" },
  { en: "scarce", th: "ขาดแคลน", cat: "adjective" },
  { en: "sophisticated", th: "ซับซ้อน, ทันสมัย", cat: "adjective" },
  { en: "substantial", th: "อย่างมาก, มีนัยสำคัญ", cat: "adjective" },
  { en: "sustainable", th: "ยั่งยืน", cat: "adjective" },
  { en: "systematic", th: "เป็นระบบ", cat: "adjective" },
  { en: "viable", th: "ที่เป็นไปได้, ใช้งานได้จริง", cat: "adjective" },
  { en: "widespread", th: "แพร่หลาย", cat: "adjective" },
